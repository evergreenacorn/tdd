...
# страница содержит "1: Купить павлиные перья" в качестве
# элемента списка

# Текстовое поле по-прежнему приглашает ее добавить еще один
# элемент. Она вводит "Сделать мушку из павлиных перьев"
# (Эдит очень методична)

# Страница снова обновляется, и теперь показывает оба
# элемента ее списка

# Эдит интересно, запомнит ли сайт ее список. Далее она
# видит, что сайт сгенерировал для нее уникальный URL-адрес
